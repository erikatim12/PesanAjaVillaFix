...
if submit : st.write("-----Bukti Pemesanan-----"), st.write("Nama : ",nama), st.write("Tanggal Check-in : ",tci), st.write("Tanggal Check-out : ",tco), st.write("Nomor Villa : ",booking_villa), st.write("Jumlah Hari Pemesanan : ",jumlah_booking), st.write("Jumlah yang Harus Dibayar: Rp.{}".format(bayar)), st.write("Silahkan bawa bukti ini saat anda mengunjungi Villa!")